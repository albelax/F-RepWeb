...
function TangleCube( _x, _y, _z, c_x = 0, c_y = 0, c_z = 0, _size = 1, _value = 11.8 )
{
	...
	var y = ( _y - c_y ) / _size;
	var z = ( _z - c_z ) / _size;
	return eval( "-(x*x*x*x - 5*x*x + y*y*y*y - 5*y*y + z*z*z*z - 5*z*z +"+ _value +")" );
}
...
function SuperEllipsoid( _x, _y, _z, _a = 1, _b = 1, _c = 1, c_x = 0, c_y = 0, c_z = 0, _s1 = 0.2, _s2 = 0.2 )
{
	...
	var f = "1-( Math.pow( Math.pow( (x/_a),(2/_s2)) + Math.pow( (y/_b), (2/_s2) ), (_s2/_s1) )) - Math.pow( (z/_c), (2/_s1) )";
	return eval( f );
}
...
function Cone(_x, _y, _z, _r = 0.5, _h = 1)
{
	...
	var y = _y - _h;
	var z = _z;
	return eval("Math.min(y*y - (x/_r)*(x/_r) - (z/_r)*(z/_r), -( _y * _y - _h ))");
}
